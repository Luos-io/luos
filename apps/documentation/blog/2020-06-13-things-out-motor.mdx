...
In this equation, R is the resistance of any conductive component, and i is the current which flows through this component. P_th is the thermal power, _i.e._, the power _(2)_, which is transformed in pure heat emitted from the component.
