...
image: /documentation-assets/images/blog/luos-web-app-alpha-version.png
hide_table_of_contents: false
date: 2022-04-15T10:00
---

![img alt](/documentation-assets/images/blog/luos-web-app-alpha-version.png)
...
![(1) Illustration of the exchange of data between Luos and Luos Engine](/documentation-assets/images/blog/web-app-protocol-luos.png)
...
![Illustration of the routing table data](/documentation-assets/images/blog/routing-table-data-luos.png)

Illustration of the routing table data

![Illustration of the service's data](/documentation-assets/images/blog/service-data-luos.png)
...
![Network Display of Luos web app](/documentation-assets/images/blog/network-display-luos.png)
