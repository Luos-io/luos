...
This new covering of MCU family makes Luos compatible with the IoT world product development. It offers the possibility to make new tools for Luos, like a [gate](/tools/gate) or an [inspector](/tools/inspector), to communicate with an embedded product on a computer through Wi-Fi or Bluetooth.
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/blog/communication_esp32_arduino_and_luos_engine_white.svg',
      dark: '/assets/images/blog/communication_esp32_arduino_and_luos_engine_dark.svg',
    }}
...
<div align="center">
  <Image
    sources={{ light: '/assets/images/gate_pipe.svg', dark: '/assets/images/gate_pipe_dark.svg' }}
