...
This new covering of MCU family makes Luos compatible with the IoT world product development. It offers the possibility to make new tools for Luos, like a [gate](/docs/tools/gate), to communicate with an embedded product on a computer through Wi-Fi or Bluetooth.
