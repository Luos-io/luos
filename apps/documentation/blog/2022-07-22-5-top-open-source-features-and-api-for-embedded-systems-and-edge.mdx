...
If you want to know more about the bootloader, please visit our [documentation](/tools/bootloader).
...
As we explain in [our documentation](/tools/gate), the default behavior of the gate is optimized for a system that has only drivers and controls all behavior through a remote computer.
