...
If you want to know more about the bootloader, please visit our [documentation](/documentation/tools/bootloader).
...
As we explain in [our documentation](/documentation/tools/gate), the default behavior of the gate is optimized for a system that has only drivers and controls all behavior through a remote computer.
...
Find the features listed in this article in our _Luos engine_ library on <a rel="noopener noreferrer external nofollow" href="https://github.com/Luos-io/luos_engine" target="_blank">GitHub</a>
...
All these open-source features are freely available on <a rel="noopener noreferrer external nofollow" href="https://github.com/Luos-io/luos_engine" target="_blank">our GitHub repository</a>

<h2> Bonus: JSON API interacts with your embedded system </h2>

Making open-source JSON API allows developers to quickly adapt the code to their needs and benefit from the community's latest updates. Many programming languages widely use JSON formatted data. [Gate](/documentation/tools/gate) services allow you to convert any information into JSON objects so that traditional programming languages can easily interact with your device.

The use of the JSON language makes it easy to develop new services and applications: [discover more on our documentation.](/documentation/tools/api-json)
