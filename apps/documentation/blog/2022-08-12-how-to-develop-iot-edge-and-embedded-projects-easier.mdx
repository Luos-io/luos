...
<div style={{ display: 'flex', alignItems: 'center' }}>
  <div style={{ textAlign: 'center' }}>
    <Image
      ...
      sources={{ light: '/assets/images/blog/Nosecone_mold_of_our_rocket_Luos.jpeg' }}
    />
  ...
  <div style={{ marginLeft: 10, textAlign: 'center' }}>
    <Image
      ...
      sources={{ light: '/assets/images/blog/Representation-of-our-rocket-Luos.png' }}
    />
