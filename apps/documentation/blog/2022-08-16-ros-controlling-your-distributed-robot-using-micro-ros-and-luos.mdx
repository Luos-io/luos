...
> 💡 For more information regarding the exchange of messages using Luos, you can check out this documentation page: [https://www.luos.io/docs/documentation/luos-technology/message](/documentation/luos-technology/messages)
...
> 💡 Using the [Topic feature](/documentation/luos-technology/messages), we can require a service to subscribe to a specific topic and to publish data of a topic by sending Luos messages of mode TOPIC.
...
> 💡 The topology detection is necessary for constructing a [Luos routing table](/documentation/luos-technology/services/routing-table) containing all the necessary information for the communication between the Luos services.
