...
The services can communicate, no matter where they are in the network, using [messages]/documentation/luos-technology/messages#message-structure) standardized by Luos.
