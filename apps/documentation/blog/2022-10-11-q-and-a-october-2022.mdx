...
In theory, you can make Luos work with **any kind of board**, but we have some boards that are already available on which you don't have to write one line of code to make it work. We have a whole page dedicated to this in our **[documentation](/docs/compatibility/mcu_demoboard)**.
