...
One of the key benefits of using microservices and cyber-physical systems is their ability to support [scalability](/documentation/luos-technology#good-practices-with-luos) and resilience.
