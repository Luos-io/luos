...
<div align="center">
  <Image
    src="/assets/images/blog/native/luos-native-digital-twin.svg"
    darkSrc="/assets/images/blog/native/luos-native-digital-twin-dark.svg"
  />
</div>
...
To sum up, the Luos Native and Digital Twin are related technologies that offer flexible solutions for testing and developing Luos architectures. They will be key tools for improving the efficiency and effectiveness of our work in the future. To know more about what we are planning to release over the nexts months, take a look at [our _roadmap_](/roadmap).
