...
<Grid container spacing={1}>
  <Grid item xs={12} md={6}>
    <Image
      sources={{
        light: '/assets/images/blog/what-is-luos/luos-benefits-for-winky.jpg',
        dark: '/assets/images/blog/what-is-luos/luos-benefits-for-winky.jpg',
      }}
    />
  </Grid>
  <Grid item xs={12} md={6}>
    <Image
      sources={{
        light: '/assets/images/blog/what-is-luos/luos-benefits-for-winky-single-system.jpg',
        dark: '/assets/images/blog/what-is-luos/luos-benefits-for-winky-single-system.jpg',
      }}
    />
  </Grid>
</Grid>
...
<iframe
  src="https://giphy.com/embed/AiIomPCEDypvg13Z9y"
  frameBorder="0"
  width="100%"
  height="100%"
  allowFullScreen
...
For example, Luos includes tools for [monitoring](/docs/tools/monitoring), [managing](/docs/tools/gate), and [updating products remotely](/docs/tools/bootloader), following a CI/CD (continuous integration/continuous deployment) methodology.
