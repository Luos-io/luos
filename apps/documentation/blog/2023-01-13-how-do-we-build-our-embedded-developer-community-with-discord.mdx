...
image: /assets/images/blog/discord-community/how-do-we-build-our-embedded-developer-community-with-discord.png
...
<h2>
  Instant messaging, okay but Is your audience used to consult and exchange on only-chat
  applications?
</h2>
...
![Roles on Trailhead - Salesforce](/assets/images/blog/discord-community/roles-on-trailhead-salesforce.png)
...
![Automatic welcome message on Discord](/assets/images/blog/discord-community/Automatic-welcome-message-on-Discord.png)
...
![Crowd.dev with Luos](/assets/images/blog/discord-community/crowd-dev-with-luos.png)
...
<a href="/tutorials/get-started" class="pagination-nav\_\_link" style={{ display: 'inline-block' }}>
