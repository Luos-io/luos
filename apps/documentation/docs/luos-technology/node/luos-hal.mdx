...
The <a href="https://github.com/Luos-io/luos_engine/tree/main/engine/HAL" target="_blank" rel="external nofollow">Luos engine HAL_</a> don't configure any network interface; the Luos engine's HAL and the phy's HAL are seperated.
