...
The Routing Table is designed and shared among all the nodes after a process that is called [detection](/documentation/luos-technology/services/routing-table).

<a
  href="/documentation/luos-technology/services/routing-table"
  target="_blank"
