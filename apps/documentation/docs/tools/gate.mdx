...
The gate service must be used with a driver service called **pipe** that can be hosted into different kinds of <Tooltip def={useDocusaurusContext().siteConfig.customFields.node_def}>node</Tooltip> allowing you to choose the communication way fitting with your project (USB, Wifi, Bluetooth, etc.).
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/gate_pipe_separate.svg',
      dark: '/assets/images/gate_pipe_separate-dark.svg',
    }}
  />
</div>
