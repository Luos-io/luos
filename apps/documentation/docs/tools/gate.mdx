...
You can use it to take control of any embedded service with [any languages](/docs/tools/api-json) on any machine. For example, we use it in [Pyluos](/docs/integrations/pyluos) or [ROS](/docs/integrations/ros).
...
The default process described above can be changed using different configurations that you can use in [the file _node_config.h_](/docs/luos-technology/basics/organization#configuration).
