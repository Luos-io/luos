...
You can use it to take control of any embedded service with [any languages](/docs/test/api) on any machine. For example, we use it in [Pyluos](/docs/test/tools/pyluos) or [ROS](/docs/test/tools/ros).
...
The default process described above can be changed using different configurations that you can use in [the file _node_config.h_](/docs/test/luos-technology/basics/orga#configuration).
