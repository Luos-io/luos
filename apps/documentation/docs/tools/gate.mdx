...
You can use it to take control of any embedded service with [any languages](/docs/api) on any machine. For example, we use it in [Pyluos](/docs/integrations/pyluos) or [ROS](/docs/integrations/ros).
