...
const Integration = (props) => {
  ...
  const links = {
    ...
    eclipse: '/docs/test/luos-technology/basics/orga#luos-engines-levels',
    vscodeico: '/docs/test/luos-technology/basics/orga#luos-engines-levels',
    ros: '/docs/test/tools/ros',
    freertos: '/docs/test/tools/ros',
    microros: '',
    simplefoc: '',
    zapier: '',
    ifttt: '',
    freedom: '',
    c: '',
    python: '/docs/test/tools/pyluos#required-installing-python-and-pip',
    js: '',
    ts: '',
  };
