...
:::info
Those custom types are product level information. Following the [Luos project code organization](https://docs.luos.io/documentation/next/luos-technology/basics/orga), you should create the `alarm_t` enum into the `product_config.h`.
:::
