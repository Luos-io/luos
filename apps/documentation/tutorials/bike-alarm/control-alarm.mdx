...
:::info
Those custom types are product level information. Following the [Luos project code organization](https://www.luos.io/docs/next/docs/luos-technology/basics/organization), you should create the `alarm_t` enum into the `product_config.h`.
:::
