...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/Gate_project.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/gate_detect.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/detect_bootloader.png' }} />
</div>
...
:::info
For further information on the options used with the CLI, please read the dedicated [documentation page](tools/bootloader), or type the following command:
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/application_load.png' }} />
</div>

:::warning
If any problem occurs during the loading process, please reboot your system and retry typing the command (you can also find information [here](tools/bootloader)).
:::

Then relaunch a detection (as done in **Step 3**):

<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/detect_old_app.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/bootloader/detect_new_app.png' }} />
</div>

You have reached the end of this tutorial. You are now able to use the bootloader's feature included in Luos engine. You know the basics, but you can find some more helpful information on the dedicated [documentation page]/tools/bootloader).
