...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/3o7btNa0RUYa5E7iiQ/giphy.gif' }}
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-1.png' }} />
</div>

3. Import the project in your IDE:

<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-2.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-3.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-4.png' }} height="300px" />
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-5.png' }} height="300px" />
</div>

7. Now that you have placed all the necessary parts of the code in the RAM, you need to rebuild the code:

<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-6.png' }} />
</div>

a. Choose your target and your USB port to upload the firmware:

<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/esp/esp-1-7.png' }} />
</div>
