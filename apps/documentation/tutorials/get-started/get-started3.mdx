...
image: /assets/images/get-started/Get-Started-Part-3-banner-Luos.png
...
In this part, we will use the “default wiring” defined by Luos to create a network of two MCUs. We will use a [OneWire network](/documentation/hardware-consideration/electronics), limiting the circuit to simple wires and pins:

- Tx and Rx pins, which are connected together and wired to the Tx and Rx pins of the other board (see the next image).
- One PTP wire.

:::tip
💡 Luos Point-To-Point (PTP) connection allows to find your board's [physical position](/documentation/luos-technology/node/topology). Luos engine can deal with up to 8 PTP lines on each board to connect as many boards as you want.
...
<div align="center">
  <Image
    src="/assets/images/get-started/get-started-3.png"
    darkSrc="/assets/images/get-started/get-started-3-dark.png"
  />
</div>
...
<Tabs>
  <TabItem value="Arduino MKR" label="Arduino MKR">
    <div align="center">
      <Image
        src="/assets/images/get-started/get-started-3-1.png"
        darkSrc="/assets/images/get-started/get-started-3-1-dark.png"
      />
    </div>
  </TabItem>
  <TabItem value="Arduino Classic" label="Arduino Classic">
    <div align="center">
      <Image
        src="/assets/images/get-started/get-started-3-2.png"
        darkSrc="/assets/images/get-started/get-started-3-2-dark.png"
      />
    </div>
  </TabItem>
  <TabItem value="NUCLEO 32" label="NUCLEO 32">
    <div align="center">
      <Image
        src="/assets/images/get-started/get-started-3-3.png"
        darkSrc="/assets/images/get-started/get-started-3-3-dark.png"
      />
    </div>
  </TabItem>
  <TabItem value="NUCLEO 64" label="NUCLEO 64">
    <Tabs>
      <TabItem value="STM32F072RB" label="STM32F072RB">
        <div align="center">
          <Image
            src="/assets/images/get-started/get-started-3-4.png"
            darkSrc="/assets/images/get-started/get-started-3-4-dark.png"
          />
        </div>
      </TabItem>
      <TabItem value="STM32F401RE/STM32F410RB" label="STM32F401RE/STM32F410RB">
        <div align="center">
          <Image
            src="/assets/images/get-started/get-started-3-5.png"
            darkSrc="/assets/images/get-started/get-started-3-5-dark.png"
          />
        </div>
      </TabItem>
    </Tabs>
...
<div align="center">
  <Image
    src="/assets/images/get-started/get-started-3-6.png"
    darkSrc="/assets/images/get-started/get-started-3-6.png"
  />
</div>
...
<div align="center">
  <Image
    src="/assets/images/get-started/get-started-3-7.png"
    darkSrc="/assets/images/get-started/get-started-3-7.png"
  />
</div>
...
You can check out our [tutorials](/tutorials) to learn more about Luos and understand how to use the features of Luos engine. We also invite you to check out our [documentation](/documentation/luos-technology) to learn more about the core concepts of Luos engine.
