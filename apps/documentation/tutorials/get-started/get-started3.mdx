...
:::tip
💡 Luos Point-To-Point (PTP) connection allows you to find your board's [physical position]/luos-technology/node/topology). Luos engine can deal with up to 8 PTP lines on each board to connect as many boards as you want.
