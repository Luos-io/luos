...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/3o6UB3VhArvomJHtdK/giphy.gif' }}
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/tutorials/morse/morse-3-1.png',
      dark: '/assets/images/tutorials/morse/morse-3-1-dark.png',
    }}
  />
</div>
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/tutorials/morse/morse-3-2.png',
      dark: '/assets/images/tutorials/morse/morse-3-2-dark.png',
    }}
  />
</div>
...
:::info
If you want more information about the pipe, you can check the corresponding [documentation page](/documentation/tools/gate).
:::
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/morse/morse-3-3.png' }} />
</div>

Then click to the Serial Monitor button in platformIO:

<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/morse/morse-3-4.png' }} />
</div>
...
<div align="center">
  <Image sources={{ light: '/assets/images/tutorials/morse/morse-3-5.png' }} />
</div>
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/xT0xeF9hBOWZzAGEr6/giphy.gif' }}
    className="gif_tutorial"
    alt="gif_sheldon"
  />
</div>
