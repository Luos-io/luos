...
In the case that you have a network, you need a way to detect other MCUs in this network. With the Luos network, we use two pins (see the documentation page [topology and network](/docs/test/luos-technology/node/topology) for more information).
