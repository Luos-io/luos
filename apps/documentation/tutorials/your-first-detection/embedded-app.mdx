...
<div align="center">
  <Image
    src="/assets/images/your-first-message/your-first-message-2-1.png"
    darkSrc="/assets/images/your-first-message/your-first-message-2-1-dark.png"
  />
</div>
...
<div align="center">
  <Image src="/assets/images/your-first-message/your-first-message-2-1.png" darkSrc="/assets/images/your-first-message/your-first-message-2-1-dark.png"/>
</div>
</TabItem>
</Tabs>
...
Asking the value of the button every 10ms represents a not negligible portion of code. Luos engine provides an `update_time` command to simplify it, check the [documentation associated page](/documentation/luos-technology/message/advanced-message) to learn more about it.
