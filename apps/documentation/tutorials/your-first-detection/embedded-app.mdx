...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/tutorials/your-first-message/your-first-message-2-1.png',
      dark: '/assets/images/tutorials/your-first-message/your-first-message-2-1-dark.png',
    }}
  />
</div>
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/l4q8cJzGdR9J8w3hS/giphy.gif' }}
...
Asking the value of the button every 10ms represents a not negligible portion of code. Luos engine provides an `update_time` command to simplify it, check the [documentation associated page](/documentation/luos-technology/messages/advanced-message) to learn more about it.
