...
Asking the value of the button every 10ms represents a not negligible portion of code. Luos engine provides an `update_time` command to simplify it, check the [documentation associated page](luos-technology/messages/advanced-message) to learn more about it.
