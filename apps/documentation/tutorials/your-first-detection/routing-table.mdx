...
:::info
To learn more about routing table filters, feel free to check out [the related documentation page](luos-technology/services/routing-table).
:::
...
:::info
A field `result_nbr` (see **[search_result_t](luos-technology/services/routing-table)** structure) gives you the number matching your search.
