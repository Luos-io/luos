...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/z1GQ9t8FxipnG/giphy-downsized-large.gif' }}
...
:::info
To learn more about routing table filters, feel free to check out [the related documentation page](/documentation/luos-technology/services/routing-table).
:::
...
:::info
A field `result_nbr` (see [search_result_t](/documentation/luos-technology/services/routing-table) structure) gives you the number matching your search.
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/zcCGBRQshGdt6/giphy.gif' }}
    className="gif_tutorial"
