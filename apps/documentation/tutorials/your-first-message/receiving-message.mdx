...
<div align="center">
  <Image
    src="/assets/images/your-first-message/your-first-message-1.png"
    darkSrc="/assets/images/your-first-message/your-first-message-1-dark.png"
...
- Asynchronous reception (Callback)
  <div align="center">
    <Image
      src="/assets/images/your-first-message/your-first-message-1-1.png"
      darkSrc="/assets/images/your-first-message/your-first-message-1-1-dark.png"
      alt="async reception"
    />
  </div>
...
- Synchronous reception (Polling)
  <div align="center">
    <Image
      src="/assets/images/your-first-message/your-first-message-1-2.png"
      darkSrc="/assets/images/your-first-message/your-first-message-1-2-dark.png"
      alt="sync reception"
    />
  </div>
