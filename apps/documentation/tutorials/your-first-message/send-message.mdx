...
<div align="center">
  <Image
    sources={{
      light: 'https://c.tenor.com/GM0o1UWir1wAAAAC/i-dont-know-how-it-works-eric-cartman.gif',
    }}
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/tutorials/your-first-message/your-first-message-2.png',
      dark: '/assets/images/tutorials/your-first-message/your-first-message-2.png',
    }}
  />
</div>
...
:::info
For more information about the messages, you can refer to [the related documentation page](https://www.luos.io/documentation/documentation/luos-technology/messages).
:::
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/DIxETbmfEdc6A/giphy-downsized-large.gif' }}
    className="gif_tutorial"
    alt="gif_test"
  />
</div>
...
<div align="center">
  <Image sources={{ light: "/assets/images/tutorials/your-first-message/your-first-message-2-1.png", dark: "/assets/images/tutorials/your-first-message/your-first-message-2-1-dark.png" }}/>
</div>
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/fSRs6SJH6m0c3iG2hk/giphy.gif' }}
    className="gif_tutorial"
    alt="gif_ligth"
  />
</div>
