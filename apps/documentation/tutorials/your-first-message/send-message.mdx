...
<div align="center">
  <Image
    src="/assets/images/your-first-message/your-first-message-2.png"
    darkSrc="/assets/images/your-first-message/your-first-message-2.png"
  />
</div>
...
:::info
For more information about the messages, you can refer to [the related documentation page](https://docs.luos.io/documentation/luos-technology/message).
:::
