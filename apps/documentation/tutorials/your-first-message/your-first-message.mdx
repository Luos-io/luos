...
- Asynchronous reception (Callback)
  <div align="center">
    <Image
      sources={{
        light: '/assets/images/tutorials/your-first-message/your-first-message-1-1.png',
        dark: '/assets/images/tutorials/your-first-message/your-first-message-1-1-dark.png',
      }}
      alt="async reception"
    />
  </div>
...
- Synchronous reception (Polling)
  <div align="center">
    <Image
      sources={{
        light: '/assets/images/tutorials/your-first-message/your-first-message-1-2.png',
        dark: '/assets/images/tutorials/your-first-message/your-first-message-1-2-dark.png',
      }}
      alt="sync reception"
    />
  </div>
