...
Thanks to that, we can put the service in a folder, move it as we want, and share all our services extremely easily. We call it a [package](/docs/test/luos-technology/package).
