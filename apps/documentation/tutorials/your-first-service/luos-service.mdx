...
A service is an encapsulated feature defining an API and allowing other services to interact with it (see the [documentation](luos-technology/services)).
...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/tutorials/your-first-service/luos-service-1.png',
      dark: '/assets/images/tutorials/your-first-service/luos-service-1-dark.png',
    }}
  />
</div>
...
<div align="center">
  <Image
    sources={{ light: 'https://c.tenor.com/gZRvEFMyTQYAAAAd/khaby-lame.gif' }}
    className="gif_tutorial"
    alt="gif_khaby"
  />
</div>
...
<div align="center">
  <Image
    sources={{ light: 'https://media.giphy.com/media/3o7qDSOvfaCO9b3MlO/giphy.gif' }}
    className="gif_tutorial"
