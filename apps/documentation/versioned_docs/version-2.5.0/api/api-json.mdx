...
image: /documentation-assets/images/Luos-and-JSON-API-banner.png
...
<h1>
  <a href="#json-api" className="header" id="json-api">
    <Image src="/documentation-assets/images/json-logo.png" width="80px" alt="json-logo" /> / JSON
    API
  </a>
</h1>
...
<div align="center">
  <Image src="/documentation-assets/images/luos-network-ex.png"></Image>
</div>
