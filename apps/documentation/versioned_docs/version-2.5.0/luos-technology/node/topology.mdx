...
The [Routing Table](../services/routing-table) is designed and shared among all the nodes after a process that is called [detection](../services/routing-table).

:::info
More details about routing table on the [dedicated page](../services/routing-table).
:::
