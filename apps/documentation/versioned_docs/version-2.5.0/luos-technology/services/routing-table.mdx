...
:::info
Routing tables can be easily displayed using [Pyluos](../../integrations/pyluos) through a [USB gate](../../tools/gate). Please refer to the [Pyluos routing table section](../../integrations/pyluos) for more information.
:::
