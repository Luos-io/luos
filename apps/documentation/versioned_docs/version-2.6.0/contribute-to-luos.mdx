...
|                                            Label                                             | Description                                                                                                                    |
| :------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------- |
|   <Image sources={{ light: "/assets/images/label-help-wanted-light.png" }} height="20" />    | This label is our call for contribution. You will see it for issues we need help from the community to work on with us.        |
| <Image sources={{ light: "/assets/images/label-good-first-issue-light.png" }} height="20" /> | This label is for issues we consider as easy, and that are good to work on if you want to begin your journey as a contributor. |
|     <Image sources={{ light: "/assets/images/label-advanced-light.png" }} height="20" />     | The advanced label is for more complicated issues that will require advanced skills.                                           |
