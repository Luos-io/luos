...
<div align="center">
  <Image
    sources={{
      light: '/assets/images/routing-table.svg',
      dark: '/assets/images/routing-table-dark.svg',
    }}
  />
</div>
...
:::info
Routing tables can be easily displayed using [Pyluos](../../integrations/pyluos.mdx) through a [USB gate(/documentation/tools/gate.mdx). Please refer to the [Pyluos routing table section](../../integrations/pyluos.mdx) for more information.
:::
